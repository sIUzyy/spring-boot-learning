...
public class MyGlobalExceptionHandler {
    ...
    public ResponseEntity<APIResponse> myResourceNotFoundException(ResourceNotFoundException e){ // ResourceNotFoundException is a custom error class we created (This is the method that will run when that error happens.)

        // This gets the message from the exception
        String message = e.getMessage();

        // use the custom class api response we created
